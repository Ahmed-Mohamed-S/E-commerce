...
<head>
	...
	<!-- title -->
	<title>{{__('string.E-commerce')}}</title>
						...
						<nav class="main-menu" dir="rtl">
                            <ul>
                              ...
                              @if (Auth::user() && (Auth::user()->role == 'admin' || Auth::user()->role == 'salesman'))
                                ...
                                <li><a href="addproduct"> {{__('string.addProducts')}}</a></li>
                                {{-- <li><a href="productstable"> {{__('string.addProducts')}}</a></li> --}}
                                @endif
                                <li><a href="reviews">{{__('string.Customer opinions')}}</a></li>
                                {{-- <li><a href="/">من نحن</a></li> --}}
                                <li><a href="#">{{__('string.bages')}}</a></li>
                                <li>
                             ...
                             @guest
                                ...
                                <li>
                                 <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{__('string.logout')}}</a>
                          ...
                          @endguest
							...
							{{-- <ul>
                                ...
                                <li><a href="{{route('prods')}}">المنتجات</a></li>
								<li><a href="{{route('cats')}}">الاقسام</a></li>
				...
				<div class="col-lg-12">
					...
					<div class="search-bar">
						<div class="search-bar-tablecell">
							<h3>ابحث على جميع المنتجات الخاصة بينا</h3>
					...
					<div class="col-md-12 col-lg-7 offset-lg-1 offset-xl-0">
						<div class="hero-text">
							<div class="hero-text-tablecell">
								...
								<h1>احدث صيحات الموضةو التسوق</h1>
								<div class="hero-btns">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-10 offset-lg-1 text-right">
						<div class="hero-text">
							<div class="hero-text-tablecell">
								<p class="subtitle">عروض قوية على جميع المنتجات</p>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="footer-box subscribe">
						...
						<p>اشترك لتحلك كل التحديثات على برديد الالكتروني.</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<p>حقوق الملكية محفوظة لدى موقع &copy; 2024 - <a href="https://imransdesign.com/">Imran Hossain</a>,  All Rights Reserved.<br>
